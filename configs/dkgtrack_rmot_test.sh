...
CHECKPOINT="${CHECKPOINT:-${PROJECT_ROOT}/exps/driftguard_refer_kitti_v2/checkpoint0059.pth}"
TEXT_ENCODER_PATH="${TEXT_ENCODER_PATH:-roberta-base}"
OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_ROOT}/exps/driftguard_refer_kitti_v2/eval}"
...
python3 "${PROJECT_ROOT}/inference.py" \
  ...
  --inference_video_ids 0005 0011 0013 0019 \

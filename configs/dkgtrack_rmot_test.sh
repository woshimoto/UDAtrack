...
CHECKPOINT="${CHECKPOINT:-${PROJECT_ROOT}/exps/sgdp_track_refer_kitti_v2/checkpoint.pth}"
TEXT_ENCODER_PATH="${TEXT_ENCODER_PATH:-roberta-base}"
OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_ROOT}/exps/sgdp_track_refer_kitti_v2/eval}"

...
class TransRMOT(nn.Module):
    def __init__(self, backbone, transformer, num_classes, num_queries, num_feature_levels, criterion, track_embed,
        ...
        self.tokenizer = RobertaTokenizerFast.from_pretrained('/data2/lgy/RMOT/work3/dkgtrack/roberta_base/',
                                                              local_files_only=True)
        self.text_encoder = RobertaModel.from_pretrained('/data2/lgy/RMOT/work3/dkgtrack/roberta_base/',
                                                         local_files_only=True)
